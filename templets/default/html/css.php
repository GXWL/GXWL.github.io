...
#word{	
	...
	margin-top:<?php echo $style['logo_top']+ $style['logo_height']?>px;
...
/* 线路列表元素 */
   #word li{	
	...
	<?php echo $CONFIG["play"]['style']['line_style']?>
		
	}	
		
#word li:hover{
<?php echo $CONFIG["play"]['style']['line_hover']?>
	  	
	}		
	
#playlist li:hover,#flaglist li:hover,#word li:hover{
<?php echo $CONFIG["play"]['style']['play_hover']?>
