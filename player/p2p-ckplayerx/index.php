...
#stats{display:none;position:absolute;top:8px;left:40px;font-size:12px;color:#F2F2F2;z-index:2147483647;text-shadow:1px 1px 1px #000, 1px 1px 1px #000}
</style>
</head>
<body >
<div class="video">
...
<script type="text/javascript">
	 ...
	 var live =_GET('live')==="1" ? 1: 0;
         var seektime=_GET('seektime')==="1" ? 1 : 0;
	 ...
	 autoplay: autoplay,
        ...
        if(_GET('p2pinfo')!=="0" ){ 
             $("#stats").show();
            videoObject["hlsjsConfig"]={   // hlsjs和CDNBye的配置参数
            debug: false,
            ...
            p2pConfig: {
                ...
                getStats: function (totalP2PDownloaded, totalP2PUploaded, totalHTTPDownloaded) {
                    ...
                    var word = 'P2P已加速' + Math.round(totalP2PDownloaded/1024) + 'MB 已分享' + Math.round(totalP2PUploaded/1024)+ 'MB' + ' 占比' + (Math.round(totalP2PDownloaded/total*100)) + '%';
