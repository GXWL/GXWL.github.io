    ...
    <body>
                        ...
                        <textarea name="BLACKLIST_BLACK_INFO"  style="height:500px"   class="layui-textarea" placeholder="请输入支持脚本"></textarea>
                           <div class="layui-form-mid layui-word-aux">
                            脚本，输入对应语言内容，PHP脚本常用命令介绍如下：<br>
                             ...
                             2. 跳转网址： 例子(延时3秒跳转)：header("Refresh:3;url=http://baidu.com"); <br> 
                        </div> 
                    </div>
                </div>
        ...
        <script>
            layui.use(['form', 'layer'], function () {
               ...
               //监听提交
               form.on('submit(add)', function (data) {  data.field.type = 'black_black_add'; x_admin_post("admin.php", data.field); return false;});
           });
