...
<html lang="zh-cmn-Hans">
    ...
    <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text"  name="BLACKLIST_MATCTH_FOR" autocomplete="off" placeholder=".*" class="layui-input" >	
                    <div class="layui-form-mid layui-word-aux">
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea name="BLACKLIST_MATCTH_VAL"  style="height:300px"   class="layui-textarea" placeholder="请输入支持内容,每行一条"> </textarea>
                         <div class="layui-form-mid layui-word-aux">
                          拦截对象，输入对应类型内容,每行一条，具体方法如下：<br>
                          支持变量$host(解析域名)及空值<br>
                          1.域名白名单(防盗链)： 类型选择“来源域名”，规则选择"不匹配时拦截",此处需输入授权域名,如：mov.baidu.com<br>
                          2.域名黑名单：类型选择“来源域名”，规则选择"匹配时拦截",此处需输入非法域名,如：mov.av.com<br>
                          3.视频黑/白名单：类型选择“目标域名”，规则选择"匹配时拦截"或"不匹配时拦截",此处需输入视频域名,如：av.net<br>
