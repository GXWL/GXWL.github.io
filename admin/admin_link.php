    ...
    <body>
        ...
        <div class="x-body">
            ...
            <table class="layui-table">
                ...
                <tbody>
                    <?php foreach ($CONFIG["LINK_URL"] as $key => $val): ?>	
                        <tr>
                            <td>
        ...
        <script>
            ...
            function member_stop(obj, id) 
            {
                ...
                {
                  layer.confirm('确认停用吗？', function (index){x_admin_post("admin.php", {"type": "link_stop", "id": id});});
                } else {
                   x_admin_post("admin.php", {"type": "link_start", "id": id});           
                }
            };
            
            /*用户-删除*/
            function member_del(obj, id){layer.confirm('确认要删除吗？', function (index){ x_admin_post("admin.php", {"type": "link_del", "id": id}); });}
           ...
           /*用户-删除 多选*/
            ...
            layer.confirm('确认要删除吗？' + data, function (index) {x_admin_post("admin.php", {"type": "link_del", "id": id}); });
            }
