    ...
    <body>
        ...
        <div class="x-body">
            ...
            <xblock>
                ...
                <button class="layui-btn" onclick="x_admin_show('添加新规则', 'admin_black_match_add.php')"><i class="layui-icon"></i>添加</button>
                    ...
                    <?php foreach ($CONFIG["BLACKLIST"]['match'] as $key => $val): ?>	
                        ...
                        <tr>
                            ...
                            <td class="td-manage">
                                ...
                                <a title="编辑"  onclick="x_admin_show('防火墙规则编辑(序号：<?php echo $key; ?>)', 'admin_black_match_edit.php?id=<?php echo $key; ?>')" href="javascript:;">
